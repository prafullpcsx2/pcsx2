...
{
    if (g_conf.ftw) {
        wxString info("The OnePad GUI is mostly provided to map keyboard/mouse to the virtual PS2 pad.\n\n"
                      "Gamepads/Joysticks are Plug & Play. Player Gamepad can be selected in the 'Gamepad Configuration' panel.\n\n"
